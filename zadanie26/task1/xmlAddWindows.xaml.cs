...
namespace z1
{
    ...
    public partial class xmlAddWindows : Window
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                XmlElement userElem = xDoc.CreateElement($"bus");

                // создаем атрибут name
                XmlAttribute pointOfDeparture = xDoc.CreateAttribute($"name");
                XmlElement companyElem = xDoc.CreateElement($"number");
                XmlElement destin = xDoc.CreateElement("toPlace");
